...
* Fixed incomplete serialization hierarchy warnings (UAC1002) in Unity 6 for `InteractableEventRoute`, `InteractableParentEventRoute`, and `InteractableChildrenEventRoute` in `InteractableEventRouter`. [PR #1136](https://github.com/MixedRealityToolkit/MixedRealityToolkit-Unity/pull/1136)
