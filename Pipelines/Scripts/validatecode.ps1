...
$InitializeOnLoadExceptions = [System.Collections.Generic.HashSet[String]]@(
    "com.mrtk.core/Editor/MRTKSettings.cs",
    "com.mrtk.core/Editor/EditorProjectUtilities.cs",
    "com.mrtk.core/Editor/MRTKProjectValidation.cs",
    "com.mrtk.input/Editor/InputValidation.cs",
    "com.mrtk.windowsspeech/Editor/WindowsSpeechValidation.cs"
)
...
$AssemblyTypesExceptions = [System.Collections.Generic.HashSet[String]]@(
    "com.mrtk.core/Utilities/Extensions/AssemblyExtensions.cs"
)
...
function CheckAsmDef {
    ...
    process {
        ...
        #             $containsIssue = $true
        #         }
        if ($FileName -match "com.mrtk" -and -not (Test-Path (Join-Path (Split-Path $FileName) "AssemblyInfo.cs"))) {
            Write-Warning @"
