...
namespace MixedReality.Toolkit.UX
{
    ...
    public class UXBindingConfigurator : MonoBehaviour
    {
        ...
        /// <summary>
        /// Configures data binding for this prefab whenever the Data Binding and Theming package (org.mixedreality.mrtk.data) is
        /// included.
        ///
        ...
        protected void TryDataBindingConfiguration()
        {
            if (bindingProfile != null)
            {
                ...
                {
                    Debug.LogWarning("To enable theming and data binding, add the org.mixedreality.mrtk.data Data Binding and Theming package.");
