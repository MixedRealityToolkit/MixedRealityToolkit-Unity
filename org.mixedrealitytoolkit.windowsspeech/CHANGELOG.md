...
* Fixed compiler warning CS0414 for `confidenceLevel` on non-Windows platforms in `WindowsKeywordRecognitionSubsystemConfig` and `WindowsDictationSubsystemConfig`. [PR #1145](https://github.com/MixedRealityToolkit/MixedRealityToolkit-Unity/pull/1145)
