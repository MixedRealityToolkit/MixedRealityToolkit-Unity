...
namespace MixedReality.Toolkit.Input
{
    ...
    public class InteractionModeManager : MonoBehaviour
    {
        ...
        public void InitializeControllers()
        {
            ...
            foreach (XRController xrController in FindObjectUtility.FindObjectsOfType<XRController>())
            {
        ...
        public void InitializeInteractionModeDetectors()
        {
            ...
            foreach (IInteractionModeDetector detector in FindObjectUtility.FindObjectsOfType<MonoBehaviour>().OfType<IInteractionModeDetector>())
            {
