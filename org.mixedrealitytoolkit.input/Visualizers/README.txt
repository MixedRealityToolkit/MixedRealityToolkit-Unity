...
To add glTFast package to your project, go to
	Window -> Package Manager -> '+ icon' -> Add package by name...
	Use: com.unity.cloud.gltfast

To add KTX package to your project. go to
	Window -> Package Manager -> '+ icon' -> Add package from git url
	Use: https://github.com/atteneder/KtxUnity.git#v2.1.2
