...
* Fixed pointer reticles remaining stuck on WorldSpace UI elements or scene surfaces when hand tracking is lost. [PR #1139](https://github.com/MixedRealityToolkit/MixedRealityToolkit-Unity/pull/1139)
