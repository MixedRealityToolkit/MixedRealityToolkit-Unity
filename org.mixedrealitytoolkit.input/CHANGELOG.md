...
* Fixed incomplete serialization hierarchy warning (UAC1002) in Unity 6 by adding `[Serializable]` to `HandBasedPoseSource`. [PR #1137](https://github.com/MixedRealityToolkit/MixedRealityToolkit-Unity/pull/1137)
